...
var db= new mongo.Db('hiringBoost', new mongo.Server(hostMongo,portMongo,{}));
...
//		  exports.addSelfInfo(linkedinSelf);
		exports.addSelfInfo(JSON.stringify(linkedinSelf));
...
db.open( function(error, client) {
	...
	collection = new mongo.Collection(client, 'contacts');
